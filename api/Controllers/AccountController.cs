...
*/
   ...
   [HttpPost("registerq")] /* not working as receiving NULL in both parameters, reason mentioned above */
   public async Task<ActionResult<AppUser>>Register(string username, string password)
    ...
    public async Task<ActionResult<UserDto>>Login(LoginDto loginDto)
    {
        ...
        why AWAIT is used here?
        here, we are making the request to database hence it may take time to perform the operation.
        hence we need to wait till it is done, thats why, AWAIT is used. */
